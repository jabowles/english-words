...
def sample_data():
    print("Called sample_data")
    return (  processlib.storedWord() )

def test_basiclink(sample_data):
    n =  sample_data
...
def test_basiclink2(sample_data):
    n =  sample_data
...
def test_add_multiple_cases(a, b, isGood, sample_data):
    n =  sample_data
